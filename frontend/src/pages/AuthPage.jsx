...
const AuthPage = ({ mode: initialMode }) => {
  ...
  const inputClassName = 'w-full min-h-[44px] bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-xl pl-10 pr-4 py-3 text-white placeholder:text-[rgba(255,255,255,0.35)] text-sm focus:outline-none focus:border-[#8b5cf6] transition-colors';
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-6 sm:py-10">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="w-full rounded-2xl border border-[rgba(139,92,246,0.2)] bg-[rgba(255,255,255,0.05)] backdrop-blur-xl p-4 sm:p-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full min-h-[44px] rounded-xl bg-[#7c3aed] hover:bg-[#8b5cf6] disabled:opacity-60 text-white text-sm font-semibold transition-all flex items-center justify-center gap-2"
              >
                {loading
                  ? 'Processing...'
                  : mode === 'login'
            ...
            <div className="mt-6 text-center">
              {mode === 'login' ? (
                <p className="text-[rgba(255,255,255,0.6)] text-sm">
                  ...
                  <Link to="/register" className="text-[#8b5cf6] hover:text-[#a78bfa] font-medium">
                    Register free
                  </Link>
                </p>
              ) : (
                <p className="text-[rgba(255,255,255,0.6)] text-sm">
                  ...
                  <Link to="/login" className="text-[#8b5cf6] hover:text-[#a78bfa] font-medium">
                    Login
                  </Link>
                </p>
              )}
