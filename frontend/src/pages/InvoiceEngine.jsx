...
export default function InvoiceEngine() {
  ...
  const handleParse = async () => {
    ...
    try {
      ...
      trackFeatureUsed('invoice_order_parsed');
  ...
  const handleDownload = () => {
    ...
    trackFeatureUsed('invoice_pdf_downloaded');
...
Generated by TaxSathi AI · taxsathi.ai`;
    ...
    trackFeatureUsed('invoice_shared_whatsapp');
    toast.success('Opening WhatsApp…');
  };

  const fillSample = () => {
    trackFeatureUsed('invoice_sample_loaded');
